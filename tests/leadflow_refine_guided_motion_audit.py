...
URL=os.environ.get("LEADFLOW_URL","http://127.0.0.1:8805/")
OUT=os.environ.get("LEADFLOW_MOTION_OUT","/tmp/leadflow-refine-motion")
...
audit(1440,950,9640)
audit(390,844,9641)
print("REFINE_GUIDED_MOTION=PASS",URL)
