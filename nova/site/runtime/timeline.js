...
const PRODUCT_POSE_KEYFRAMES = [
  // V3: continuous, restrained source-clip motion. Product states remain alive
  // without the visible expand/snap reversals that competed with the detail story.
  [0.000,.240],[0.045,.260],[0.090,.280],[0.120,.290],
  [0.160,.300],[0.180,.310],[0.200,.320],[0.240,.310],[0.280,.300],
  [0.300,.320],[0.320,.340],[0.360,.380],[0.410,.400],[0.450,.420],
  [0.490,.440],[0.540,.470],[0.580,.490],
  [0.620,.520],[0.670,.580],[0.720,.540],
  [0.760,.500],[0.790,.480],[0.830,.460],[0.860,.450],
  [0.900,.430],[0.945,.370],[0.960,.390],[0.985,.360],[1.000,.340]
];
...
function viewportAdjusted(state, viewportClass){
  if(viewportClass === 'mobile'){
    ...
    if(state.range === 'hero'){
      state.product.position[1] -= 1.16;
      state.camera.target[1] += .045;
    }
