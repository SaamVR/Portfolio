...
const KEYFRAMES = [
  ...
  {p:0.28, pose:.22, pos:[.18,.00,0], scale:1.06, yaw:.24, pitch:-.018, cam:[-.32,.10,4.45], target:[-.14,.02,0], fov:26.4, exposure:1.08, hemi:1.9, key:4.7, fill:1.25, rim:8.4, warm:4.8, keyColor:0xffead6, rimColor:0xce7648, keyPos:[3.2,4.0,5.0], tone:.18, spatial:.06, spread:.58, adaptive:0, openness:.76, motion:.22},
