...
const KEYFRAMES = [
  ...
  {p:0.62, pose:.72, pos:[.28,-.045,0], scale:1.06, yaw:.18, pitch:.025, cam:[-.35,.10,4.38], target:[.05,0,0], fov:26.5, exposure:1.13, hemi:1.25, key:5.15, fill:.90, rim:9.8, warm:5.3, keyColor:0xffdfc1, rimColor:0xbd6840, keyPos:[3.0,3.65,4.8], tone:.70, spatial:.50, spread:.75, adaptive:.35, openness:.56, motion:.36},
  {p:0.67, pose:.72, pos:[.32,-.04,0], scale:1.07, yaw:.22, pitch:.03, cam:[-.38,.12,4.28], target:[.06,0,0], fov:26.3, exposure:1.12, hemi:1.45, key:5.0, fill:1.00, rim:9.3, warm:5.1, keyColor:0xffe2c7, rimColor:0xbf6c42, keyPos:[3.1,3.75,4.9], tone:.56, spatial:.36, spread:.70, adaptive:.24, openness:.62, motion:.31},
  {p:0.72, pose:.32, pos:[.22,-.04,0], scale:1.05, yaw:.12, pitch:0, cam:[-.28,.08,4.62], target:[.03,-.02,0], fov:27.0, exposure:1.10, hemi:1.65, key:4.7, fill:1.1, rim:8.7, warm:5.0, keyColor:0xffe6ce, rimColor:0xc07045, keyPos:[3.2,3.8,5.0], tone:.42, spatial:.25, spread:.67, adaptive:.15, openness:.68, motion:.28},
