...
assert.ok(v3MobileHero.product.position[1] < -.50,
  `V3 mobile Hero should keep the lower earcups fully above the NOVA wordmark safe area, got y=${v3MobileHero.product.position[1]}`);
