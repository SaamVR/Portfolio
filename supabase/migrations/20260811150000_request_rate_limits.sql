...
grant all on public.request_rate_limits to postgres;
...
revoke all on function public.check_request_rate_limit(text, integer, integer) from public;
revoke all on function public.check_request_rate_limit(text, integer, integer) from anon;
revoke all on function public.check_request_rate_limit(text, integer, integer) from authenticated;

grant execute on function public.check_request_rate_limit(text, integer, integer) to service_role;
grant all on function public.check_request_rate_limit(text, integer, integer) to postgres;
