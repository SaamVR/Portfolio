-- #150 compatibility migration A: introduce separate operational configuration and verification truth.
-- This migration intentionally keeps legacy `connected` temporarily so old and new runtimes can overlap safely.
