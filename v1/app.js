(() => {
  ...
  async function qualifyOnServer(data, settingsOverride=null){
    ...
    try{
      ...
      trace.textContent="POST /v1/api/qualify";
      const response=await fetch("/v1/api/qualify",{
        method:"POST",
      ...
      for(let i=0;i<stages.length;i++){
        if(i===2){
          ...
          if(serverResult){
            ...
            logEvent("api.qualify","Structured qualification returned from /v1/api/qualify","ok");
          }else{
