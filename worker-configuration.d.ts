/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/ezcomo-custom-domain-proxy/wrangler.jsonc` (hash: 89c4aa28799f7ae283b58a6648c3225b)
// Runtime types generated with workerd@1.20260722.1 2026-08-11 
interface __BaseEnv_Env {
	DOMAIN_ROUTING_KV: KVNamespace;
	ORIGIN_HOSTNAME: "origin.ezcomo.shop";
	PLATFORM_DOMAIN: "ezcomo.shop";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/ezcomo-custom-domain-proxy/worker");
	}
