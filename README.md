...
**Verified application release:** `0ba97313`
...
- Secure tenant bootstrap with confirmed-account auth, Owner-only server assignment, request-fingerprint idempotency and paused-by-default server authority
