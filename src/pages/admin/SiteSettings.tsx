...
import { Loader2, Save, Plus, Trash2, GripVertical, MessageCircle } from "lucide-react";
            ...
            <CardContent className="space-y-5">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="8801XXXXXXXXX (include country code, no +)"
                />
                <p className="text-xs text-muted-foreground">
                  Include the country code without + (e.g. <span className="font-mono">8801712345678</span> for Bangladesh).
                </p>
              </div>
              ...
              <div className="grid gap-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  This message will be auto-typed when the customer opens WhatsApp.
                </p>
              </div>
