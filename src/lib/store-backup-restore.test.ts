...
function manifest(){return validateRestoreManifest({
  ...
  data:{
    ...
    orders:[{id:ORDER,user_id:USER,order_number:"ORD-1",status:"pending",items:[{productId:PRODUCT,quantity:1}],subtotal:1000,delivery_fee:60,total:1060,customer_name:"Customer",customer_phone:"01700000000",shipping_address:"Address",shipping_city:"Dhaka",payment_method:"bkash_manual",manual_payment_provider:"bkash",manual_payment_reference:"TRX_1234"}],
    ...
    store_page_blocks:[{id:"16161616-1616-4616-8616-161616161616",page_id:PAGE,block_type:"products",props:{productId:PRODUCT,pageId:PAGE},sort_order:0,is_visible:true,responsive_config:{hiddenOn:[]}}],
    store_page_revisions:[{id:"17171717-1717-4717-8717-171717171717",page_id:PAGE,blocks_snapshot:[{props:{productId:PRODUCT,pageId:PAGE}}],revision_label:"Source"}],
