...
export const storefrontTemplateRegistry: Record<StorefrontTemplateId, StorefrontTemplateDefinition> = {
  ...
  threads: createTemplateDefinition("threads", {
    ...
    adminOnly: true,
    recommendedBlockSet: ["hero", "category-showcase", "promo-banner", "recommended-products", "featured-products", "trust-badges", "faq-accordion", "rich-text"],
    defaultBlockSet: ["hero", "category-showcase", "promo-banner", "recommended-products", "featured-products", "trust-badges", "faq-accordion", "rich-text"],
    presentation: {
      sectionOrder: ["hero", "category-showcase", "promo-banner", "recommended-products", "featured-products", "trust-badges", "social-feed", "faq-accordion", "rich-text", "testimonials", "comparison", "recently-viewed", "countdown", "video-reel"],
      visibleSections: ["hero", "category-showcase", "promo-banner", "recommended-products", "featured-products", "trust-badges", "faq-accordion", "rich-text"],
      cardStyle: "fashion-editorial",
      imageRatio: "4:5",
      borderRadius: "0.5rem",
...
export const storefrontTemplateSeedRegistry: Record<StorefrontTemplateId, StorefrontTemplateSeedDefinition> = {
  ...
  fashion: createTemplateSeedDefinition("fashion", {
    ...
    recommendedBlockSet: ["hero", "trust-badges", "featured-products", "category-showcase", "promo-banner", "social-feed", "testimonials", "rich-text", "faq-accordion", "recently-viewed"],
    defaultTheme: {
    ...
    hero: {
      ...
      title: "Redefine Your",
      highlight: "Everyday.",
      subtitle: "Curated essentials designed to move with you. Shop new arrivals with free delivery over ৳2,000.",
    },
