...
export const fallbackStoreBlueprints: StoreBlueprintDefinition[] = [
  {
    ...
    recommendedBlockSet: ["hero", "promo-banner", "category-showcase", "featured-products", "testimonials", "social-feed", "trust-badges"],
  ...
  },
  {
    ...
    shortName: "Gadgets",
    description: "A sharper electronics storefront for devices, accessories, bundles, and feature-led launches.",
    businessFamily: "commerce",
    catalogMode: "multi_product",
    group: "Electronics / Gadgets",
    recommendedPageSet: ["home", "about", "policy"],
    recommendedBlockSet: ["hero", "promo-banner", "featured-products", "video-reel", "rich-text", "faq-accordion", "trust-badges"],
    defaultTheme: {
    ...
    storeDescription: "Smart devices, practical accessories, spec-led merchandising, and purchase-confidence messaging for modern buyers.",
    hero: {
  ...
  },
  {
    ...
    shortName: "Crafts",
    description: "A warmer story-led storefront for handmade goods, gifts, commissions, and small-batch collections.",
    businessFamily: "commerce",
    catalogMode: "multi_product",
    group: "Crafts / Handmade",
    recommendedPageSet: ["home", "about", "policy"],
    recommendedBlockSet: ["hero", "promo-banner", "featured-products", "rich-text", "social-feed", "testimonials", "trust-badges"],
    defaultTheme: {
      presetId: "warm-earth",
      mode: "light",
      headingFont: "'Outfit', sans-serif",
    ...
    storeDescription: "Handmade collections, limited batches, maker stories, and gift-friendly merchandising for independent brands.",
    hero: {
  ...
  },
  {
    ...
    name: "Food & Menu",
    shortName: "Food",
    description: "A menu-style storefront for daily specials, bakery drops, meal boxes, and local ordering.",
    businessFamily: "commerce",
    catalogMode: "menu",
    group: "Food / Menu",
    recommendedPageSet: ["home", "about-kitchen"],
    recommendedBlockSet: ["hero", "promo-banner", "featured-products", "social-feed", "rich-text", "faq-accordion", "trust-badges"],
    defaultTheme: themeFromTemplate("food"),
    storeDescription: "Fresh food, bakery bestsellers, daily specials, and local-order confidence built into the buying flow.",
    hero: {
      tagline: "Fresh Today",
      title: "Homemade",
      highlight: "Goodness",
  ...
  },
  {
    ...
    description: "A focused launch flow for one flagship item, bundle, preorder, or campaign-led hero product.",
    businessFamily: "commerce",
    catalogMode: "single_product",
    group: "Single Product",
    recommendedPageSet: ["home", "policy"],
    recommendedBlockSet: ["hero", "promo-banner", "video-reel", "rich-text", "faq-accordion", "testimonials", "trust-badges"],
    defaultTheme: {
      presetId: "ocean-teal",
      mode: "dark",
      headingFont: "'Outfit', sans-serif",
  ...
  },
  {
    ...
    shortName: "Catalog",
    description: "A flexible default for mixed-product stores that need a polished, conversion-ready starting point.",
    businessFamily: "commerce",
    catalogMode: "multi_product",
    group: "General Catalog",
    recommendedPageSet: ["home", "about", "policy"],
    recommendedBlockSet: ["hero", "promo-banner", "category-showcase", "featured-products", "rich-text", "faq-accordion", "social-feed", "trust-badges"],
    defaultTheme: themeFromTemplate("general"),
    storeDescription: "A flexible storefront for products, bundles, promotions, and everyday ecommerce operations with stronger discovery and trust pacing.",
    hero: {
  ...
  },
  {
    ...
    shortName: "Inquiry",
    description: "A browse-only catalog for quote-based or assisted selling, with hidden prices, proof sections, and lead capture.",
    businessFamily: "commerce",
    catalogMode: "inquiry_only",
    group: "Inquiry / Browse Only",
    recommendedPageSet: ["home", "about", "contact"],
    recommendedBlockSet: ["hero", "promo-banner", "featured-products", "rich-text", "faq-accordion", "testimonials", "trust-badges"],
    defaultTheme: {
    ...
    storeDescription: "Show products, services, or collections without forcing direct checkout, and convert interest into qualified conversations.",
    hero: {
