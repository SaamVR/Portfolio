...
const HERO_SPLIT_OPTIONS = {
  alignment: { allowedValues: ["left", "center"], defaultValue: "left" },
  contentWidth: { allowedValues: ["narrow", "standard", "wide"], defaultValue: "standard" },
  mediaFit: { allowedValues: ["cover", "contain"], defaultValue: "cover" },
  emphasis: { allowedValues: ["balanced", "strong"], defaultValue: "balanced" },
  spacing: { allowedValues: ["compact", "comfortable", "airy"], defaultValue: "comfortable" },
  mobileBehavior: { allowedValues: ["stack", "compact"], defaultValue: "stack" },
} satisfies StorefrontVariantOptionCapabilities;

const HERO_CENTERED_OPTIONS = {
  alignment: { allowedValues: ["center", "left"], defaultValue: "center" },
  contentWidth: { allowedValues: ["narrow", "standard"], defaultValue: "narrow" },
  emphasis: { allowedValues: ["quiet", "balanced", "strong"], defaultValue: "balanced" },
  spacing: { allowedValues: ["compact", "comfortable", "airy"], defaultValue: "comfortable" },
  mobileBehavior: { allowedValues: ["stack", "compact"], defaultValue: "stack" },
} satisfies StorefrontVariantOptionCapabilities;

const CATEGORY_CARDS_OPTIONS = {
  contentWidth: { allowedValues: ["standard", "wide"], defaultValue: "wide" },
  spacing: { allowedValues: ["tight", "compact", "comfortable"], defaultValue: "compact" },
  mobileBehavior: { allowedValues: ["stack", "scroll", "compact"], defaultValue: "stack" },
} satisfies StorefrontVariantOptionCapabilities;

const CATEGORY_RAIL_OPTIONS = {
  contentWidth: { allowedValues: ["standard", "wide"], defaultValue: "wide" },
  spacing: { allowedValues: ["tight", "compact", "comfortable"], defaultValue: "compact" },
  mobileBehavior: { allowedValues: ["scroll", "compact"], defaultValue: "scroll" },
} satisfies StorefrontVariantOptionCapabilities;

const PRODUCT_GRID_OPTIONS = {
  contentWidth: { allowedValues: ["standard", "wide"], defaultValue: "wide" },
  emphasis: { allowedValues: ["quiet", "balanced", "strong"], defaultValue: "balanced" },
  spacing: { allowedValues: ["tight", "compact", "comfortable"], defaultValue: "compact" },
  mobileBehavior: { allowedValues: ["stack", "compact"], defaultValue: "compact" },
} satisfies StorefrontVariantOptionCapabilities;

const PRODUCT_RAIL_OPTIONS = {
  contentWidth: { allowedValues: ["standard", "wide"], defaultValue: "wide" },
  emphasis: { allowedValues: ["quiet", "balanced", "strong"], defaultValue: "balanced" },
  spacing: { allowedValues: ["tight", "compact", "comfortable"], defaultValue: "compact" },
  mobileBehavior: { allowedValues: ["scroll", "compact"], defaultValue: "scroll" },
...
const PROMO_OPTIONS = {
  alignment: { allowedValues: ["left", "center", "right"], defaultValue: "center" },
  contentWidth: { allowedValues: ["narrow", "standard", "wide"], defaultValue: "standard" },
  emphasis: { allowedValues: ["quiet", "balanced", "strong"], defaultValue: "balanced" },
  spacing: { allowedValues: ["compact", "comfortable", "airy"], defaultValue: "comfortable" },
} satisfies StorefrontVariantOptionCapabilities;

const MEDIA_PROMO_OPTIONS = {
  ...PROMO_OPTIONS,
  mediaFit: { allowedValues: ["cover", "contain"], defaultValue: "cover" },
  mobileBehavior: { allowedValues: ["stack", "compact"], defaultValue: "stack" },
} satisfies StorefrontVariantOptionCapabilities;
...
export const canonicalStorefrontVariantRegistry: readonly StorefrontVariantDefinition[] = [
  ...
  variant({ id: "split", blockType: "hero", optionCapabilities: HERO_SPLIT_OPTIONS, label: "Editorial Split", description: "Two-part hero with content and media side by side on larger screens.", guidance: "Mobile stacks to one column; do not rely on desktop side-by-side placement for meaning.", rendererKey: "hero/split", responsive: HERO_SPLIT_RESPONSIVE, safeFallback: "centered", performanceClass: "standard", interactionRequirement: "none", editor: { group: "layout", order: 20, preview: "schematic", badge: "recommended" } }),
  variant({ id: "centered", blockType: "hero", optionCapabilities: HERO_CENTERED_OPTIONS, label: "Minimal Product Focus", description: "Centered hero copy with optional supporting media.", guidance: "Safest general-purpose hero and fallback when specialized requirements are unavailable.", rendererKey: "hero/centered", responsive: MOBILE_STACK, safeFallback: "centered", performanceClass: "light", interactionRequirement: "none", editor: { group: "layout", order: 30, preview: "schematic", badge: "recommended" } }),
  ...
  catalogVariant({ id: "cards", blockType: "category-showcase", optionCapabilities: CATEGORY_CARDS_OPTIONS, label: "Image Cards", description: "Category cards with optional media.", guidance: "General-purpose category presentation with safe icon fallbacks.", rendererKey: "category-showcase/cards", responsive: MOBILE_GRID, safeFallback: "compact-list", performanceClass: "standard", interactionRequirement: "none", editor: { group: "commerce", order: 10, preview: "thumbnail", badge: "recommended" } }),
  catalogVariant({ id: "carousel", blockType: "category-showcase", optionCapabilities: CATEGORY_RAIL_OPTIONS, label: "Compact Editorial Rail", description: "Horizontally scrollable category rail.", guidance: "Keep touch scrolling primary on mobile; arrows are enhancement only.", rendererKey: "category-showcase/carousel", responsive: MOBILE_CAROUSEL, safeFallback: "cards", performanceClass: "interactive", interactionRequirement: "carousel", requirements: { minItems: 2 }, editor: { group: "commerce", order: 20, preview: "thumbnail" } }),
  ...
  variant({ id: "image-campaign-banner", blockType: "promo-banner", optionCapabilities: MEDIA_PROMO_OPTIONS, label: "Image Campaign Banner", description: "Full-width campaign image with overlaid promotional copy and CTA.", guidance: "Use only with strong campaign media and concise copy.", rendererKey: "promo-banner/image-campaign-banner", responsive: MOBILE_STACK, safeFallback: "campaign-cta", performanceClass: "media-heavy", interactionRequirement: "none", requirements: { requiresPrimaryMedia: true, recommendedContentKeys: ["badgeText"] }, editor: { group: "media", order: 30, preview: "thumbnail", badge: "media" } }),
  ...
  variant({ id: "campaign-cta", blockType: "promo-banner", optionCapabilities: PROMO_OPTIONS, label: "Campaign CTA", description: "Typography-led campaign call to action without mandatory media.", guidance: "Use for launches and timely offers when message hierarchy matters more than imagery.", rendererKey: "promo-banner/campaign-cta", responsive: MOBILE_STACK, safeFallback: "standard", performanceClass: "light", interactionRequirement: "none", editor: { group: "content", order: 50, preview: "thumbnail", badge: "recommended" } }),
