...
export const DEFAULT_STORE_DESCRIPTION = "A local preview storefront used for demo, development, and fallback flows.";
export const DEFAULT_STORE_CURRENCY_CODE = "BDT";
export const DEFAULT_STORE_LOCALE = "en-BD";

const defaultStoreData = {
  id: DEFAULT_STORE_ID,
  name: "Local Preview Store",
  slug: "local-preview-store",
  ...
  pages: [
    {
      ...
      slug: "/",
      title: "Home",
      seoTitle: "Local Preview Store",
      seoDescription: "Preview storefront content, layout, and customer flows during development.",
      isHomepage: true,
      blocks: [
        {
          id: "block-countdown",
    ...
    },
    {
      ...
      slug: "/about",
      title: "About",
      seoTitle: "About Local Preview Store",
