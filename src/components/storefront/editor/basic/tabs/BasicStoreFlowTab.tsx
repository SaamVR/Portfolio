            ...
            <div className="mt-4 grid gap-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="grid gap-1.5 sm:col-span-2">
                  <Label className="text-xs">Primary Zone Cities</Label>
                  <Input
                  ...
                  />
                  <p className="text-[11px] text-gray-500 dark:text-gray-400">Only these exact city names receive the primary delivery rate. Other cities use the extended rate.</p>
                </div>
                <div className="grid gap-1.5">
