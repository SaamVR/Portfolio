...
import { ArrowLeft, ArrowRight, Check, CreditCard, Leaf, PackageCheck, RotateCcw, Shirt, Sparkles } from "lucide-react";
...
function ThreadsNewArrivals({ block }: { block: StorePageBlock }) {
  ...
  const title=isReferenceStore(store?.id)?"New at EZCOMO":(s(p.title)||"New at Threads");
