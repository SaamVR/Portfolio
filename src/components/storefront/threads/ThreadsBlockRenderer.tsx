  ...
  return <section className="relative overflow-hidden bg-primary py-9 text-primary-foreground md:py-11">
    ...
    <div className="mx-auto grid max-w-[1280px] gap-6 px-5 md:grid-cols-[205px_minmax(0,1fr)] md:px-8">
      <div className="relative z-10 flex flex-col justify-center">
        ...
        <Link href={storefrontPath("/shop",store?.slug)} className="mt-5 inline-flex min-h-11 w-fit items-center gap-4 rounded-sm border border-primary-foreground/45 px-4 py-2.5 text-[9px] uppercase tracking-[.1em]">View All Products<ArrowRight className="h-3.5 w-3.5"/></Link>
