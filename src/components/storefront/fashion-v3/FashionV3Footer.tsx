      ...
      <div className="mx-auto max-w-[1500px] px-5 py-12 md:px-8 md:py-16 lg:px-12">
        <div className="grid gap-12 md:grid-cols-12 md:gap-8">
          <div className="md:col-span-4">
            ...
            {store?.description ? <p className="mt-4 max-w-sm text-sm leading-6 text-muted-foreground">{store.description}</p> : null}
          </div>
          <div className="grid grid-cols-2 gap-8 md:col-span-5 md:grid-cols-3">
            <div>
              <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-primary">Shop</p>
            ...
            <div>
              <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-primary">Information</p>
            ...
            <div className="col-span-2 md:col-span-1">
              <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-primary">Customer care</p>
          ...
          <div className="md:col-span-3 md:text-right">
            ...
            <p className="mt-6 text-xs text-muted-foreground">© {new Date().getFullYear()} {store?.name || "Store"}</p>
          </div>
        </div>
      </div>
    </footer>
