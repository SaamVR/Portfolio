...
export function FashionV3Shell({ children, embedded = false }: { children: ReactNode; embedded?: boolean }) {
  return (
    <div data-storefront-template="fashion" data-fashion-presentation="v3" data-fashion-palette="earthy-emerald" className="min-h-screen bg-background text-foreground antialiased">
      {!embedded ? <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[120] focus:bg-background focus:px-4 focus:py-3">Skip to content</a> : null}
