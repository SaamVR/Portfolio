      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mt-12 space-y-10">
          <div className="grid gap-4 lg:grid-cols-3">
            {[
              {
                title: "1. Start with your store type",
                body: "Pick the blueprint group that looks closest to how you already sell: catalog-heavy, single-product, service-led, or inquiry-first.",
              },
              {
                title: "2. Preview the selling flow",
                body: "Check the hero, trust sections, product discovery, and support cues before worrying about colors or wording.",
              },
              {
                title: "3. Customize after signup",
                body: "Themes, copy, FAQs, promotions, and media can all be adjusted later, so choose the structure that feels most believable first.",
              },
            ].map((item) => (
