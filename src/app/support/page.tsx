...
export async function generateMetadata() {
  ...
  return {
    title: `Platform Support — ${siteName}`,
    description: `Contact ${siteName} platform support for sales, billing, account, privacy, abuse, or security questions.`,
  };
}
    ...
    <main className="min-h-screen bg-background px-5 py-12 text-foreground lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mt-12 max-w-3xl">
          ...
          <h1 className="mt-4 font-heading text-4xl font-semibold tracking-tight md:text-6xl">Ask {siteName} about the platform.</h1>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <aside className="space-y-4 rounded-[1.7rem] border border-border bg-muted/20 p-6 text-sm leading-6 text-muted-foreground">
            ...
            <p>The request is recorded in {siteName}&apos;s platform operational inbox and receives a reference ID. Platform administrators can review and resolve it separately from merchant storefront messages.</p>
