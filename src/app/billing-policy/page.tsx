...
export const metadata = {
  title: "Billing, Trial, Cancellation & Refund Policy — EZComo review version",
  description: "Published review-version billing disclosure for EZComo plans and trials.",
};
...
export default async function BillingPolicyPage() {
  const plans = await loadPublicPlanCatalog();
