...
import { Boxes, Edit3, Layers3, Loader2, Palette, Plus, Save, Share2 } from "lucide-react";
  ...
  if (authLoading) {
    return (
      <AdminRecoveryPanel
        ...
        description="Shared library permissions are loading before template and theme data can be edited."
    ...
    return (
      <Card className="border-border">
        <CardHeader>
          ...
          <CardDescription>
            The shared library is waiting for platform permissions to restore before it can load shared template and theme data.
          </CardDescription>
        </CardHeader>
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          Curate shared themes and block registry entries that power tenant-safe storefront setup.
        </p>
      </div>
      ...
      <Card className="border-border">
        <CardHeader className="gap-4">
          ...
          <div className="grid gap-2">
            ...
            <Input id="cms-library-search" value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search themes, page templates, or blocks" />
          </div>
        </CardHeader>
      </Card>
